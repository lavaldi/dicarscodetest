				...
				<div class="row-fluid">
					<div class="box span12">
						<div class="box-header well" data-original-title>
							<h2>CLIENTES</h2>
							<div class="box-icon">
								<a href="#" class="btn btn-registrar btn-round" alt="Registrar Cliente">
									<i class="icon-plus"></i>
								</a>
							</div>
						</div>
									...
									<div class="modal-body">
										<fieldset>
											<div class="control-group">
												...
												<div class="controls">
													<input class="input-xlarge focused" maxlength="50" required pattern="|^[a-zA-Z ñÑáÁéÉíÍóÓúÚüÜç]*$|" title="Este campo debe ser sólo letras" name="nombres" id="focusedInput" type="text"></div>
											</div>
											<div class="control-group">
												<label class="control-label" for="apellidos">Apellidos</label>
												<div class="controls">
													<input class="input-xlarge focused" maxlength="50" required pattern="|^[a-zA-Z ñÑáÁéÉíÍóÓúÚüÜç]*$|" title="Este campo debe ser sólo letras" name="apellidos" id="focusedInput" type="text"></div>
											</div>
											<div class="control-group">
												<label class="control-label" for="dni">DNI</label>
												<div class="controls">
													<input class="input-xlarge focused" maxlength="8" required pattern="|^\d{8}$|" title="Este campo debe tener 8 números" name="dni" id="focusedInput" type="text"></div>
											</div>
											<div class="control-group">
												<label class="control-label" for="direccion">Dirección</label>
												<div class="controls">
													<input class="input-xlarge focused" required pattern="|^([a-zA-ZñÑáÁéÉíÍóÓúÚüÜç0-9.]+\s*)+$" maxlength="200" name="direccion" id="focusedInput" type="text"></div>
											</div>
											<div class="control-group">
												<label class="control-label" for="referencia">Referencia</label>
												<div class="controls">
													<input class="input-xlarge focused" value=" " required pattern="|^[a-zA-Z ñÑáÁéÉíÍóÓúÚüÜç0-9.]+$" maxlength="200" name="referencia" id="focusedInput" type="text"></div>
											</div>
											<div class="control-group">
												<label class="control-label" for="ocupacion">Ocupación</label>
												<div class="controls">
													<input class="input-xlarge focused" value=" " required pattern="|^[a-zA-Z ñÑáÁéÉíÍóÓúÚüÜç]+$|" title="Este campo debe ser sólo letras" maxlength="40" name="ocupacion" type="text"></div>
											</div>
											<div class="control-group">
												<label class="control-label" for="lineaop">Línea Operativa</label>
												<div class="controls">
													<input class="input-xlarge focused" name="lineaop" id="lineaop" type="number" step="0.10" min="0" max="1000" required></div>
											</div>
									...
									<div class="modal-body">
										<fieldset>
											<div class="control-group">
												<label class="control-label" for="nombres">Nombres</label>
												<div class="controls">
													<input class="input-xlarge focused" maxlength="50" required pattern="|^[a-zA-Z ñÑáÁéÉíÍóÓúÚüÜç]*$|" title="Este campo debe ser sólo letras" name="nombres" id="focusedInput" type="text" value="Lourdes"></div>
											</div>
											<div class="control-group">
												<label class="control-label" for="apellidos">Apellidos</label>
												<div class="controls">
													<input class="input-xlarge focused" maxlength="50" required pattern="|^[a-zA-Z ñÑáÁéÉíÍóÓúÚüÜç]*$|" title="Este campo debe ser sólo letras" name="apellidos" id="focusedInput" type="text" value="Paredes"></div>
											</div>
											<div class="control-group">
												<label class="control-label" for="dni">DNI</label>
												<div class="controls">
													<input class="input-xlarge focused" maxlength="8" required pattern="|^\d{8}$|" title="Este campo debe tener 8 números" name="dni" id="focusedInput" type="text" value="85236974"></div>
											</div>
											<div class="control-group">
												<label class="control-label" for="direccion">Dirección</label>
												<div class="controls">
													<input class="input-xlarge focused" required pattern="|^([a-zA-ZñÑáÁéÉíÍóÓúÚüÜç0-9.]+\s*)+$" maxlength="200" name="direccion" id="focusedInput" type="text" value="Mi Casa 456"></div>
											</div>
											<div class="control-group">
												<label class="control-label" for="referencia">Referencia</label>
												<div class="controls">
													<input class="input-xlarge focused" required pattern="|^[a-zA-Z ñÑáÁéÉíÍóÓúÚüÜç0-9.]+$" maxlength="200" name="referencia" id="focusedInput" type="text" value="..."></div>
											</div>
											<div class="control-group">
												<label class="control-label" for="ocupacion">Ocupación</label>
												<div class="controls">
													<input class="input-xlarge focused" required pattern="|^[a-zA-Z ñÑáÁéÉíÍóÓúÚüÜç]+$|" title="Este campo debe ser sólo letras" maxlength="40" name="ocupacion" type="text" value="Empresaria"></div>
											</div>
											<div class="control-group">
												<label class="control-label" for="lineaop">Línea Operativa</label>
												<div class="controls">
													<input class="input-xlarge focused" name="lineaop" id="lineaop" type="number" step="0.10" min="0" max="1000" required value="1000"></div>
											</div>
